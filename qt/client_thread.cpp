...
QMutex Client_Thread::mutex;

Client_Thread::Client_Thread(QTcpSocket *clientSocket, MainWindow *mainwindow, QObject *parent) : QThread(parent), clientSocket(clientSocket), isListening(isListening)
{
